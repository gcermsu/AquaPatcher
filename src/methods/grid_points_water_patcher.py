...
def generate_grid_points_water_patches(input_img_files: str, input_path_mask: str, input_path_img: str, output_dir: str, patch_size: int = 256, min_valid_pixels = 3, set_nan: bool = True, spacing_grid: int = 100):
    '''Generate patches'''
